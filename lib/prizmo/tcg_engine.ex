defmodule Prizmo.TcgEngine do
  ...
  resources do
    ...
    resource Game do
      ...
      define :use_lumiose_city_for_game,
        action: :use_lumiose_city_command,
      ...
      define :use_pecharunt_ex_subjugating_chains_for_game,
        action: :use_pecharunt_ex_subjugating_chains_command,
        args: [:game_id, :player_id, :source_card_instance_id, :target_card_instance_id]
