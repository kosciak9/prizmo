defmodule Prizmo.Tcg.Goal1.CardCoverage do
  @moduledoc """
  Goal 1 card-level coverage classification for live latest-Limitless corpus work.

  This mirrors the same broad card support buckets used by the roadmap docs so
  the live corpus report can distinguish supported, generic, partial, and still
  unimplemented cards without spinning up a whole play surface.
  """
