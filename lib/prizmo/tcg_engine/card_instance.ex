defmodule Prizmo.TcgEngine.CardInstance do
  ...
  state_machine do
    ...
    transitions do
      ...
      transition(:attach_from_discard, from: :discard, to: :attached)
  ...
  actions do
    ...
    update :put_basic_from_discard_to_bench do
      accept [:position, :turn_entered_play]
      change transition_state(:bench)
    end
