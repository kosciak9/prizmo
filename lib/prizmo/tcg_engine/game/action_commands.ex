defmodule Prizmo.TcgEngine.Game.ActionCommands do
  ...
  actions do
    ...
    action :use_lumiose_city_command, :struct do
      description "Use Lumiose City from the active Stadium zone through the mechanics layer."
    ...
    action :use_surfing_beach_command, :struct do
      description "Use Surfing Beach from the active Stadium zone through the mechanics layer."
