defmodule Prizmo.TcgEngine.GameView.Fields do
  ...
  @base_card_summary_fields [
    ...
    stage: [type: :string],
    rules_status: [type: :string, allow_nil?: false],
    rules_label: [type: :string, allow_nil?: false],
    rules_note: [type: :string, allow_nil?: false],
  ...
  @player_view_fields [
    ...
    mulligans_taken: [type: :integer, allow_nil?: false],
    mulligan_bonus_draws_taken: [type: :integer, allow_nil?: false],
    mulligan_bonus_draws_available: [type: :integer, allow_nil?: false],
