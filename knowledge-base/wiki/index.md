...
| [Goal 2 Top 30 Latest-Limitless Coverage Scope](engine/goal-2-top-30-latest-limitless-coverage-scope.md) | Goal 2 scope: current top-30 archetype list, first live 377-card corpus snapshot, and the highest-leverage shared blockers from the new Goal 2 reporting pipeline. | 2026-06-24 |
...
| [Ash-backed TCG Engine Playtest Handoff](engine/ash-backed-tcg-engine-playtest-handoff.md) | Historical/operational handoff for prior two-deck and six-deck engine work; current agents should follow the canonical latest-Limitless/Godot roadmap instead. | 2026-06-24 |
