...
- Remaining live validation work is broader and deeper: continue two-seat play-surface runs across more of the latest-result Goal 1 fixture pool and push beyond setup/pass into mid-game turn lines when those runs provide new coverage signal.
