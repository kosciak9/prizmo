...
- Current live Alakazam latest-result cards are fully supported; remaining Goal 1 live-card gaps are the Dragapult partials (`JTG-151`, `MEG-088`) plus fixture-drift and full-play validation work.
