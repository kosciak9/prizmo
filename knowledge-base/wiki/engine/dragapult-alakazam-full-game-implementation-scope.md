...
- Current live latest-result cards and committed fixtures for both Dragapult and Alakazam are now aligned on the canonical Ash path; remaining Goal 1 work is dedicated mechanics coverage and full-play validation rather than card-definition or live-fixture drift.
